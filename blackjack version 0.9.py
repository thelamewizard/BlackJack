...
class hand:
    ...
    def makedecision(self):
        ...
        while self.hitorstand not in ('s','h'):
            ...
            for event in pygame.event.get():
                ...
                button(345,512,50,40,BLUE,(0, 245, 255),'Raise')
                button(395,512,50,40,RED,(255, 0, 175),'Lower')
                button(370,472,50,40,ORANGE,ORANGE,'Play')
...
class player:
    ...
    def increase(self):
         if self.temp_bet <= self.bankroll - 50:
             self.temp_bet += 50
    ...
    def isin(self):
        ...
        while self.bet ==0:
            ...
            for event in pygame.event.get():
                ...
                button(770,0,30,30,ORANGE,RED,'Exit',15,pygame.quit)
                button(345,512,50,40,BLUE,(0, 245, 255),'Raise',15,self.increase)
                button(395,512,50,40,RED,(255, 0, 175),'Lower',15,self.decrease)
                button(370,472,50,40,ORANGE,ORANGE,'Play',15,self.set_bet)
...
#    button(300,350,50,40,GREEN5,GREEN5)
    ...
    while hand_done:
        ...
        if a.bankroll  >0:
            ...
            for event in pygame.event.get(): 
                button(770,0,30,30,ORANGE,RED,'Exit',15,pygame.quit)
                button(345,250,100,40,ORANGE,ORANGE,'Play Again',15,begin_game)
                pygame.display.update()

        elif a.bankroll <= 0:
            message_display('Game Over!!',100,50,25,BLUE)
            button(345,250,100,40,ORANGE,ORANGE,'RESTART',15,restart_game)
            pygame.display.flip()
